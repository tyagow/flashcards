...
describe('deckReducer', () => {
  ...
  it('should add new deck when action = NEW_DECK', () => {
    ...
    expect(deckReducer(undefined, { type: NEW_DECK, payload: deck }))
      .toEqual({ items: [{ ...deck, questions: [] }], item: {} })
  })
  it('should add select deck when action = DECK_SELECTED', () => {
    const obj = { id: 1 }
    expect(deckReducer(undefined, { type: DECK_SELECTED, payload: obj }))
      .toEqual({ items: [], item: obj })
  })
